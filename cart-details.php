...
<body>
    <div class="container">
        ...
        <div class="menu cart-margin">
          <ul>
              <li><a href="/zadanie2/index.php">Strona główna</a></li>
          </ul>
        </div>
        ...
        <div class="main">
          ...
          <?php
           ...
           if (count($_SESSION['cart'])==0) {
             ...
             echo '<h3 class="cart-title"><br/><br/>Koszyk</h3>';
            ...
            $total_amount = 0;
             ...
             echo '<tr><td colspan="6"><a href="/zadanie2/order-page.php" class="order-page-link"> Złóż zamówienie </a></td></tr>';
             echo '</table>';
